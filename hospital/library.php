...
?>
    ...
    $connection = new mysqli('localhost', 'root', 'p12345', 'hospital');
    ...
    function noAccessForNormal()
    {
      ...
      if(isset($reg)) {
        if($_POST['rpassword']!=$_POST['rcpassword']) {
          $error="<br>Password does not match</br>";
       header('Location: '.$_SERVER['index.php#register1']);
       die();
        }
      }
